define(['jquery', 'underscore', 'backbone', 'vm', 'events', 'text!templates/layout.html'], 
function($, _, Backbone, Vm, Events, layoutTemplate) {
	var AppView = Backbone.View.extend({
		...
		render : function() {
			...
			require(['views/header/sgd'], function(HeaderSGDView) {
				var headerSGDView = Vm.create(that, 'HeaderSGDView', HeaderSGDView);
				headerSGDView.render();
			});
